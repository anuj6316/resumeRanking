...
class DocumentSections(BaseModel):
    ...
    education: List[str] = Field(description="List of educational qualifications mentioned")
...
sections_prompt = PromptTemplate(
    ...
    partial_variables={'format_instructions': sections_parser.get_format_instructions()}
)
